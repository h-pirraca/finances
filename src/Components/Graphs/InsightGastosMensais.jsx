...
import IGM from './IGM.module.css'
...
const InsightGastosMensais = () => {
  ...
  const fetchData = async () => {
    try {
      const response = await fetch(process.env.REACT_APP_SERVER_LINK+'/gastosMensaisU', {
        method: 'GET',
        headers: {
  ...
  return (
    <div className={IGM.Insights}>
        <div className={IGM.Box}>
            <Avatar sx = {{ bgcolor: amber[600]}}><BarChart/></Avatar>
            <div className={IGM.Middle}>
              <div className={IGM.Left}>  
                  <h4><b>Hugo</b></h4>
                  <h5 className={IGM.TextMuted}>{state.totalH} €</h5>
              </div>
              <div className={IGM.Progress}>
        ...
        <div className={IGM.Box}>
        <Avatar sx = {{ bgcolor: deepOrange[400]}}><BarChart/></Avatar>
            <div className={IGM.Middle}>
              <div className={IGM.Left}> 
                  <h4><b>Nuno</b></h4>
                  <h5 className={IGM.TextMuted}>{state.totalN} €</h5>
              </div>
              <div className={IGM.Progress}>
        ...
        <div className={IGM.Box}>
        <Avatar sx = {{ bgcolor: lightBlue[600]}}><BarChart/></Avatar>
            <div className={IGM.Middle}>
              <div className={IGM.Left}> 
                  <h4><b>Casa</b></h4>
                  <h5 className={IGM.TextMuted}>{state.totalC} €</h5>
              </div>
              <div className={IGM.Progress}>
...
export default InsightGastosMensais